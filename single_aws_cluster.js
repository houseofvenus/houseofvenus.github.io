...
// Code to run if we're in a worker process
  ...
  // author(s):  Patrice-Morgan Ongoly
    ...
    */
    ...
    app.get('/classtest', function(req, res){
        var result = new WhichBrowser(req.headers);
        console.log(result.toString());
        if(result.isType('desktop')){
            console.log('This is a desktop computer.');
        ...
        res.render('classroomtest.html',{root: dir[0]});
    });

    app.get('/jonas', function(req, res){
        var result = new WhichBrowser(req.headers);
        console.log(result.toString());
        if(result.isType('desktop')){
            console.log('This is a desktop computer.');
        ...
        res.render('jonas.html',{root: dir[0]});
    });
    ...
    app.get('/user', function(req, res){
        ...
        res.render('user.html',{root: dir[0]});
    });
    ...
    app.get('/speech', function(req, res){
        ...
        res.render('speech.html',{root: dir[0]});
    });
   ...
   /* app.get('/26', function(req, res){
    ...
    app.get('/gta', function(req, res){
        ...
        res.render('gta.html',{root: dir[0]});
    });
    ...
    app.get('/cvimg', function(req, res){
        ...
        res.render('cvimgloader.html',{root: dir[0]});
    });

    app.get('/cvvid', function(req, res){
        var result = new WhichBrowser(req.headers);
        console.log(result.toString());
        if(result.isType('desktop')){
            console.log('This is a desktop computer.');
