  ...
  // author(s):  Patrice-Morgan Ongoly
    ...
    */
    ...
    app.get('/nexus', function(req, res){
        ...
        res.render('nexus.html',{root: dir[0]});
    });

    app.get('/nexus/stream', function(req, res){
        var result = new WhichBrowser(req.headers);
        console.log(result.toString());
        if(result.isType('desktop')){
            console.log('This is a desktop computer.');
        ...
        res.render('nexus-stream.html',{root: dir[0]});
    });
    ...
    app.get('/echelearn', function(req, res){
        var result = new WhichBrowser(req.headers);
        console.log(result.toString());
        if(result.isType('desktop')){
            console.log('This is a desktop computer.');
        ...
        res.render('echelearn.html',{root: dir[0]});
    });
